 ...
 */
public class MySQLQuoteDAO extends AbstractJDBCDao<Quote, Integer> implements DAO<Quote, Integer>{
    ...
    @Override
    public Quote create() throws PersistException {
        Quote quote = new Quote();
        return persist(quote);
    }
}
